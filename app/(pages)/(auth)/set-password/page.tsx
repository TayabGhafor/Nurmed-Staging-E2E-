...
export default function SetPasswordPage() {
  ...
  useEffect(() => {
    ...
    if (token && refreshToken && (type === "invite" || type === "signup")) {
    ...
    <div className="lg:px-22 w-full max-w-[580px] rounded-[20px] bg-white p-8 shadow-lg lg:py-12">
      ...
      {done ? (
        <div className="text-center">
          <h2 className="mb-4 text-[18px] font-medium text-gray-900">
            Your password is set
          </h2>
          <p className="text-[15px] text-gray-600">
            Open the <span className="font-medium">NurMed Scribe</span> app and
            log in with your email and new password.
          </p>
        </div>
      ) : (
        <>
          <h2 className="mb-2 text-center text-[18px] font-medium text-gray-900">
            Set your password
          </h2>
          <p className="mb-8 text-center text-[14px] text-gray-600">
            Welcome to NurMed. Choose a password to activate your scribe account.
          </p>
          ...
          {isTokenLoading ? (
            <div className="space-y-5">
              <div className="animate-pulse">
                <div className="mb-4 h-12 rounded-md bg-gray-200"></div>
                <div className="mb-4 h-12 rounded-md bg-gray-200"></div>
            ...
            <form
              ...
              className="space-y-5"
              style={{ opacity: accessToken ? 1 : 0.5 }}
            >
