-- =====================================================
-- CREATE DOCTOR TABLE - BASIC STRUCTURE
-- =====================================================
-- Run this FIRST before any other scripts
-- This creates the basic doctor table structure
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_doctor_registration_number ON doctor(registration_number);
CREATE INDEX IF NOT EXISTS idx_doctor_hospital_id ON doctor(hospital_id);
CREATE INDEX IF NOT EXISTS idx_doctor_role ON doctor(role);
CREATE INDEX IF NOT EXISTS idx_doctor_is_active ON doctor(is_active);

-- Doctor hospital mapping indexes
CREATE INDEX IF NOT EXISTS idx_doctor_hospital_doctor_id ON doctor_hospital(doctor_id);
CREATE INDEX IF NOT EXISTS idx_doctor_hospital_hospital_id ON doctor_hospital(hospital_id);
...
CREATE INDEX IF NOT EXISTS idx_sessionsectiondata_session_id ON sessionsectiondata(session_id);
CREATE INDEX IF NOT EXISTS idx_sessionsectiondata_section_id ON sessionsectiondata(section_id);
